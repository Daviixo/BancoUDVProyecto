...
<body>
    ...
    <div class="page-wrapper">
            ...
            <nav class="main-menu">
                <div class="container">
                    ...
                    <ul class="main-menu__list">
                        <li class="dropdown">
                            <a href="index-1.php">INICIO</a>
                            <ul>
                                <li>
                                    <a href="index-1.php">INICIO One</a>
                                </li>
                                <li><a href="index-1.php">INICIO Two</a></li>
                                <li class="dropdown">
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="block-title text-left">
                            ...
                            <h2>Few Words About Our Company</h2>
                        </div><!-- /.block-title -->
                    </div><!-- /.col-lg-6 -->
                    <div class="col-lg-6">
                        <p class="block-text">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur.</p><!-- /.block-text -->
                    </div><!-- /.col-lg-6 -->
                </div><!-- /.row -->
            </div><!-- /.container -->
        </section><!-- /.about-three -->
        ...
        <section class="video-two">
            <div class="video-two__bg" style="background-image: url(assets/images/backgrounds/video-bg-1-1.jpg);"></div><!-- /.video-two__bg -->
            <div class="container">
        ...
        <section class="team-about-page pb-90 pt-120">
            <div class="container">
                <div class="block-title text-center">
