                ...
                <div class="row">
                    <div class="col-lg-4 col-md-6">
                        <div class="credit-card__box">
                            ...
                            <div class="credit-card__content">
                                <h3><a href="credit-card-details.php">Visa Platinum Card</a></h3>
                                <p>There are many variations of passages of lorem ipsum available the majority have some.</p>
                                <a href="credit-card-details.php" class="credit-card__link"><i class="pylon-icon-right-arrow"></i></a><!-- /.credit-card__link -->
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="credit-card__box">
                            ...
                            <div class="credit-card__content">
                                <h3><a href="credit-card-details.php">Visa Gold Card</a></h3>
                                <p>There are many variations of passages of lorem ipsum available the majority have some.</p>
                                <a href="credit-card-details.php" class="credit-card__link"><i class="pylon-icon-right-arrow"></i></a><!-- /.credit-card__link -->
                            </div><!-- /.credit-card__content -->
                        </div><!-- /.credit-card__box -->
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="credit-card__box">
                            ...
                            <div class="credit-card__content">
                                <h3><a href="credit-card-details.php">Visa Classic Card</a></h3>
                                <p>There are many variations of passages of lorem ipsum available the majority have some.</p>
                                <a href="credit-card-details.php" class="credit-card__link"><i class="pylon-icon-right-arrow"></i></a><!-- /.credit-card__link -->
                            </div><!-- /.credit-card__content -->
                        </div><!-- /.credit-card__box -->
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="credit-card__box">
                            ...
                            <div class="credit-card__content">
                                <h3><a href="credit-card-details.php">Titanium Mastercard</a></h3>
                                <p>There are many variations of passages of lorem ipsum available the majority have some.</p>
                                <a href="credit-card-details.php" class="credit-card__link"><i class="pylon-icon-right-arrow"></i></a><!-- /.credit-card__link -->
                            </div><!-- /.credit-card__content -->
                        </div><!-- /.credit-card__box -->
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="credit-card__box">
                            ...
                            <div class="credit-card__content">
                                <h3><a href="credit-card-details.php">Express Card</a></h3>
                                <p>There are many variations of passages of lorem ipsum available the majority have some.</p>
                                <a href="credit-card-details.php" class="credit-card__link"><i class="pylon-icon-right-arrow"></i></a><!-- /.credit-card__link -->
                            </div><!-- /.credit-card__content -->
                        </div><!-- /.credit-card__box -->
