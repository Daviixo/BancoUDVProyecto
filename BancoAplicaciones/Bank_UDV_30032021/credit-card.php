...
<head>
    ...
    <title>Credit Card Page || Pylon || Loan HTML Template</title>
    <!-- favicons Icons -->
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-6">
                        <div class="credit-card__box">
                            <div class="credit-card__box-image">
                                <img src="assets\images\credit-card\credit-card-1-1.png" alt="">
                            </div><!-- /.credit-card__box-image -->
                            <div class="credit-card__content">
                                <h3><a href="credit-card-details.html">Visa Platinum Card</a></h3>
                                <p>There are many variations of passages of lorem ipsum available the majority have some.</p>
                                <a href="credit-card-details.html" class="credit-card__link"><i class="pylon-icon-right-arrow"></i></a><!-- /.credit-card__link -->
                            </div><!-- /.credit-card__content -->
                        </div><!-- /.credit-card__box -->
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="credit-card__box">
                            ...
                            <div class="credit-card__content">
                                <h3><a href="credit-card-details.html">Visa Gold Card</a></h3>
                                <p>There are many variations of passages of lorem ipsum available the majority have some.</p>
                                <a href="credit-card-details.html" class="credit-card__link"><i class="pylon-icon-right-arrow"></i></a><!-- /.credit-card__link -->
                            </div><!-- /.credit-card__content -->
                        </div><!-- /.credit-card__box -->
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="credit-card__box">
                            ...
                            <div class="credit-card__content">
                                <h3><a href="credit-card-details.html">Visa Classic Card</a></h3>
                                <p>There are many variations of passages of lorem ipsum available the majority have some.</p>
                                <a href="credit-card-details.html" class="credit-card__link"><i class="pylon-icon-right-arrow"></i></a><!-- /.credit-card__link -->
                            </div><!-- /.credit-card__content -->
                        </div><!-- /.credit-card__box -->
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="credit-card__box">
                            ...
                            <div class="credit-card__content">
                                <h3><a href="credit-card-details.html">Titanium Mastercard</a></h3>
                                <p>There are many variations of passages of lorem ipsum available the majority have some.</p>
                                <a href="credit-card-details.html" class="credit-card__link"><i class="pylon-icon-right-arrow"></i></a><!-- /.credit-card__link -->
                            </div><!-- /.credit-card__content -->
                        </div><!-- /.credit-card__box -->
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="credit-card__box">
                            ...
                            <div class="credit-card__content">
                                <h3><a href="credit-card-details.html">Express Card</a></h3>
                                <p>There are many variations of passages of lorem ipsum available the majority have some.</p>
                                <a href="credit-card-details.html" class="credit-card__link"><i class="pylon-icon-right-arrow"></i></a><!-- /.credit-card__link -->
                            </div><!-- /.credit-card__content -->
                        </div><!-- /.credit-card__box -->
