...
<head>
    ...
    <title>How It Works Page || Pylon || Loan HTML Template</title>
    <!-- favicons Icons -->
    ...
    <div class="page-wrapper">
        ...
        <section class="how-works">
            <div class="container">
                <div class="row">
                    <div class="col-lg-5">
                        <img src="assets\images\resources\how-works.jpg" class="how-works__image" alt="">
                    </div><!-- /.col-lg-5 -->
                    <div class="col-lg-7">
                        <div class="how-works__content wow fadeInRight" data-wow-duration="1500ms">
                            <div class="block-title text-left">
                                <p>How Process Works</p>
                                <h2>A Quick Payment Transparent Process</h2>
                            </div><!-- /.block-title -->
                            <p class="block-text">There are many variations of pass of lorem ipsum but the majority have suffered alteration in some form. Injected humour randomised words which.</p><!-- /.block-text -->
                        </div><!-- /.how-works__content -->
                    </div><!-- /.col-lg-7 -->
                </div><!-- /.row -->
            </div><!-- /.container -->
        </section><!-- /.how-works -->
