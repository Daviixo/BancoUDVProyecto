...
<head>
    ...
    <title>Home Two || Pylon || Loan HTML Template</title>
    <!-- favicons Icons -->
...
<body>
    ...
    <div class="page-wrapper">
                            ...
                            <div class="row">
                                <div class="col-xl-8 col-lg-8">
                                    ...
                                    <div class="button-wrap">
                                        ...
                                        <a href="#" class=" thm-btn">Contact Now</a>
                                    </div><!-- /.button-wrap -->
        ...
        <section class="service-two">
            <img src="assets\images\shapes\service-shape-1-1.png" class="service-two__shape-1" alt="">
            <img src="assets\images\shapes\service-shape-1-2.png" class="service-two__shape-2" alt="">
            <img src="assets\images\shapes\service-shape-1-3.png" class="service-two__shape-3" alt="">
            <div class="container">
                <div class="row">
                    <div class="col-lg-4 wow fadeInUp" data-wow-duration="1500ms">
                        <div class="service-two__card">
                            <i class="pylon-icon-consumer-behavior"></i>
                            <h3><a href="service-details.html">Quick Payment Process</a></h3>
                            <p>There are many variations of passages of but the majority have in some.</p>
                            <a href="service-details.html" class="service-two__card-link"><i class="pylon-icon-right-arrow"></i>Read More</a><!-- /.service-two__card-link -->
                        </div><!-- /.service-two__card -->
                    </div><!-- /.col-lg-4 -->
                    <div class="col-lg-4 wow fadeInUp" data-wow-duration="1500ms">
                        <div class="service-two__card">
                            <i class="pylon-icon-point-of-sale"></i>
                            <h3><a href="service-details.html">No Prepayment
                                    Fees</a></h3>
                            <p>There are many variations of passages of but the majority have in some.</p>
                            <a href="service-details.html" class="service-two__card-link"><i class="pylon-icon-right-arrow"></i>Read More</a><!-- /.service-two__card-link -->
                        </div><!-- /.service-two__card -->
                    ...
                    <div class="col-lg-4 wow fadeInUp" data-wow-duration="1500ms">
                        <div class="service-two__card">
                            <i class="pylon-icon-strategy"></i>
                            <h3><a href="service-details.html">Safe & Secure Process</a></h3>
                            <p>There are many variations of passages of but the majority have in some.</p>
                            <a href="service-details.html" class="service-two__card-link"><i class="pylon-icon-right-arrow"></i>Read More</a><!-- /.service-two__card-link -->
                        </div><!-- /.service-two__card -->
                    </div><!-- /.col-lg-4 -->
        ...
        <section class="about-two">
            <img src="assets\images\shapes\about-shape-1-1.png" class="about-two__shape-1" alt="">
            <img src="assets\images\shapes\about-shape-1-2.png" class="about-two__shape-2" alt="">
            <img src="assets\images\shapes\about-shape-1-3.png" class="about-two__shape-3" alt="">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <div class="about-two__content">
                            ...
                            <div class="button-wrap">
                                <a href="#" class="thm-btn">Discover More</a><!-- /.thm-btn -->
                                <div class="main-header__info-phone">
                                    <i class="pylon-icon-tech-support"></i>
                                    <div class="main-header__info-phone-content">
                                        <span>Call Anytime</span>
        ...
        <section class="video-one">
            <div class="container">
                <div class="video-one__box wow fadeInUp" data-wow-duration="1500ms">
                    <div class="video-one__box-bg" style="background-image: url(assets/images/resources/video-1-1.jpg);"></div><!-- /.video-one__box-bg -->
        ...
        <section class="faq-one">
            <div class="faq-one__bg" style="background-image: url(assets/images/shapes/trust-bg-1-1.png);"></div><!-- /.faq-one__bg -->
            <div class="container">
                <div class="row">
                    <div class="col-lg-6">
                        ...
                        <ul id="accordion" class="mb-0 wow fadeInUp list-unstyled" data-wow-duration="1500ms">
                            <li>
                                ...
                                <div id="collapseTwo" class="collapse" role="button" aria-labelledby="collapseTwo" data-parent="#accordion">
                                    <p>There are many variations of the have suffer in some fo injected humour, or words believable. Lorem ipsum dolor sit amet, consectetur adip isicing elit.</p>
                                </div>
                            </li>
                            <li>
        ...
        <section class="team-home">
            <img src="assets\images\shapes\team-shape-1-1.png" alt="" class="team-home__shape-1">
            <img src="assets\images\shapes\team-shape-1-2.png" alt="" class="team-home__shape-2">
            <div class="team-home__bg" style="background-image: url(assets/images/backgrounds/team-bg-1-1.jpg);"></div><!-- /.team-home__bg -->
            <div class="container">
                <div class="row">
                    <div class="col-xl-5">
                        <div class="team-home__content">
                            ...
                            <!-- If we need navigation buttons -->
                            <div class="team-home__nav">
                                <div class="swiper-button-prev" id="team-home__swiper-button-next"><i class="pylon-icon-left-arrow"></i></div>
                                <div class="swiper-button-next" id="team-home__swiper-button-prev"><i class="pylon-icon-right-arrow"></i></div>
                            </div><!-- /.team-home__nav -->
                        </div><!-- /.team-home__content -->
                    </div><!-- /.col-lg-5 -->
                </div><!-- /.row -->
            </div><!-- /.container -->
            <div class="team-home__carousel-wrap ">
            ...
            "breakpoints": {
                ...
                "991": {
                    ...
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            <div class="team-one__card">
                                <div class="team-one__image">
                                    <img src="assets\images\team\team-1-1.png" alt="">
                                </div><!-- /.team-one__image -->
                        ...
                        <div class="swiper-slide">
                            <div class="team-one__card">
                                <div class="team-one__image">
                                    <img src="assets\images\team\team-1-2.png" alt="">
                                </div><!-- /.team-one__image -->
                                <div class="team-one__content">
                                    <div class="team-one__social">
                                        <a href="#" class="fab fa-facebook-square"></a>
                        ...
                        <div class="swiper-slide">
                            <div class="team-one__card">
                                <div class="team-one__image">
                                    <img src="assets\images\team\team-1-3.png" alt="">
                                </div><!-- /.team-one__image -->
                                <div class="team-one__content">
                                    <div class="team-one__social">
                                        <a href="#" class="fab fa-facebook-square"></a>
                        ...
                        <div class="swiper-slide">
                            <div class="team-one__card">
                                <div class="team-one__image">
                                    <img src="assets\images\team\team-1-4.png" alt="">
                                </div><!-- /.team-one__image -->
                                <div class="team-one__content">
                                    <div class="team-one__social">
                                        <a href="#" class="fab fa-facebook-square"></a>
                        ...
                        <div class="swiper-slide">
                            <div class="team-one__card">
                                <div class="team-one__image">
                                    <img src="assets\images\team\team-1-5.png" alt="">
                                </div><!-- /.team-one__image -->
                                <div class="team-one__content">
                                    <div class="team-one__social">
                                        <a href="#" class="fab fa-facebook-square"></a>
                        ...
                        <div class="swiper-slide">
                            <div class="team-one__card">
                                <div class="team-one__image">
                                    <img src="assets\images\team\team-1-6.png" alt="">
                                </div><!-- /.team-one__image -->
                                <div class="team-one__content">
                                    <div class="team-one__social">
                                        <a href="#" class="fab fa-facebook-square"></a>
        ...
        <div class="client-carousel pt-120 pb-120  ">
            <div class="container">
