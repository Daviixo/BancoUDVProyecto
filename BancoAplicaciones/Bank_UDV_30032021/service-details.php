...
<head>
    ...
    <title>Services Details Page || Pylon || Loan HTML Template</title>
    <-- favicons Icons -->
                    ...
                    <div class="col-lg-4">
                        <div class="service-sidebar">
                            ...
                            <div class="service-sidebar__call">
                                ...
                                <i class="pylon-icon-tech-support"></i>
                                <h3><a href="#">92 666 888 0000</a></h3>
                                <p>Lorem ipsum is simply free text used by copytyping porro est qui dolo.</p>
                    ...
                    <div class="col-lg-8">
                        <div class="service-details__content">
                            <div class="service-details__image">
                                <img src="assets\images\services\service-d-1-1.jpg" class="img-fluid" alt="">
                            ...
                            <p>It has survived not only five centuries. Lorem Ipsum is simply dummy text of the new design
                                printng
                                and type setting Ipsum take a look at our round. When an unknown printer took a galley of type
                                and
                                scrambled it to make a type specimen book. It has survived not only five centuries, but also the
                                leap into electronic typesetting.</p>
                            <div class="row">
                                <div class="col-xl-6">
                                    <img src="assets\images\services\service-d-1-2.jpg" alt="" class="service-details__content-image img-fluid">
                                </div><!-- /.col-md-6 -->
                                <div class="col-xl-6">
                            ...
                            <ul id="accordion" class="mb-0 wow fadeInUp list-unstyled" data-wow-duration="1500ms">
                                <li>
                                    ...
                                    <div id="collapseTwo" class="collapse" role="button" aria-labelledby="collapseTwo" data-parent="#accordion">
                                        <p>There are many variations of the have suffer in some fo injected humour, or words
                                            believable. Lorem ipsum dolor sit amet, consectetur adip isicing elit, sed do
                                            eiusmod
