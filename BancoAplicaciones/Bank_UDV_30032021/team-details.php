...
<head>
    ...
    <title>Team Details Page || Pylon || Loan HTML Template</title>
    <-- favicons Icons -->
    ...
    <div class="page-wrapper">
        ...
        <section class="team-details">
            <div class="container">
                <div class="row">
                    <div class="col-lg-6">
                        <img src="assets\images\team\team-s-1-1.jpg" class="img-fluid" alt="">
                    </div><!-- /.col-lg-6 -->
                    <div class="col-lg-6">
                        <div class="team-details__content">
                            ...
                            <p>There are many variations of passages of available but the majority have suffered alteration in
                                some form, by injected humou or randomised words which don't look even slightly believable.</p>
                            ...
                            <div class="team-details__certificates">
                                <img src="assets\images\team\team-certificate-1-1.jpg" alt="">
                                <img src="assets\images\team\team-certificate-1-2.jpg" alt="">
                            </div><!-- /.team-details__certificates -->
