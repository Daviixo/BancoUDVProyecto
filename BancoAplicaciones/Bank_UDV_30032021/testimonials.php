...
<head>
    ...
    <title>Testimonials Page || Pylon || Loan HTML Template</title>
    <!-- favicons Icons -->
...
<body>
    ...
    <div class="page-wrapper">
        ...
        <section class="testimonials-page pt-120 pb-90">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-6 ">
                        <div class="testimonials-one__box">
                            <p><span>I was very impresed by the company service lore ipsum is simply free text used by copy typing refreshing. Neque porro est dolorem ipsum quia.</span></p>
                            <div class="testimonials-one__box-info">
                                <img src="assets\images\resources\testimonials-1-4.png" alt="">
                                <h3>James Garrett</h3>
                                <span>Analytics</span>
                            </div><!-- /.testimonials-one__box-info -->
                        </div><!-- /.testimonials-one__box -->
                    ...
                    <div class="col-lg-4 col-md-6 ">
                        <div class="testimonials-one__box">
                            <p><span>I was very impresed by the company service lore ipsum is simply free text used by copy typing refreshing. Neque porro est dolorem ipsum quia.</span></p>
                            <div class="testimonials-one__box-info">
                                <img src="assets\images\resources\testimonials-1-5.png" alt="">
                                <h3>Mina McCoy</h3>
                                <span>Analytics</span>
                            </div><!-- /.testimonials-one__box-info -->
                        </div><!-- /.testimonials-one__box -->
                    ...
                    <div class="col-lg-4 col-md-6 ">
                        <div class="testimonials-one__box">
                            <p><span>I was very impresed by the company service lore ipsum is simply free text used by copy typing refreshing. Neque porro est dolorem ipsum quia.</span></p>
                            <div class="testimonials-one__box-info">
                                <img src="assets\images\resources\testimonials-1-6.png" alt="">
                                <h3>Estelle Carr</h3>
                                <span>Analytics</span>
                            </div><!-- /.testimonials-one__box-info -->
                        </div><!-- /.testimonials-one__box -->
